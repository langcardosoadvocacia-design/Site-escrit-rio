...
const SecaoEquipe = () => {
  const equipe = [
    ...
    { n: "Carla Augusti Buzzetto", a: "Advogado Associada", d: "OAB/RS 135.016. Direito Previdenciário, Direito do Trabalho.", i: IMG_CARLA },
    { n: "Bruno Iop", a: "Advogado Associada", d: "OAB/RS 118.889. Advogado Criminal, Mestre em ciências criminais.", i: IMG_BRUNO },
        ...
        <div className="container mx-auto px-6 grid md:grid-cols-3 gap-10">
          <CardInterativo className="flex flex-col">
              ...
              <div className="p-8 text-center bg-white flex-grow flex flex-col justify-center">
                ...
                <p className="text-[10px] uppercase tracking-wide text-black/40 leading-relaxed">OAB/RS 124.685. DIREITO CRIMINAL. DIREITO EMPRESARIAL. DIREITO IMOBILIARIO.</p>
              </div>
          </CardInterativo>
          {[
          { n: "Jefferson Cooper", a: "Coordenador Jurídico", d: "OAB/RS 130.300. Direito do Trabalho. Direito Criminal.", i: IMG_JEFFERSON },
